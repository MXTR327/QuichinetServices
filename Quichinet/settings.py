...
WSGI_APPLICATION = 'Quichinet.wsgi.application'
...
STATIC_ROOT = os.path.join(BASE_DIR, 'gestionClientes/staticfiles')

STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'gestionClientes/static')
]
